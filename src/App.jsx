...
export default function App() {
  ...
  const photoUrl =
      "https://www.dropbox.com/scl/fi/z2h1w4ydp7c3h2rosbbg1/14d715a8-319e-485e-b52e-7808dedb055c.png?rlkey=qg7d4wbh1hv4tkmh7w4mfke7k&st=e0n9swm9&raw=1";
            ...
            <div className="mx-auto mb-10 flex justify-center">
              <div className="ornament-ring relative p-[6px] rounded-[2.5rem]">
                ...
                <div className="bg-white rounded-[2rem] p-3 shadow-[0_20px_40px_rgba(120,83,16,0.18)]">
                  ...
                  <div className="h-[200px] w-[100px] overflow-hidden rounded-[1.5rem] sm:h-[300px] sm:w-[140px]">
                    <img
                        src={photoUrl}
                        alt="Мерейтой иесі"
